...
GoogleFontsFile? getGoogleFontsUriFromFontQuery(PdfFontQuery query, {bool preferCJK = true}) {
  ...
  final Map<PdfFontCharset, Map<int, GoogleFontsFileSingle>?> isRomanTrue = {
    ...
    PdfFontCharset.greek: query.isItalic ? _notoSerifItalic : _notoSerif,
    PdfFontCharset.vietnamese: query.isItalic ? _notoSerifItalic : _notoSerif,
    PdfFontCharset.cyrillic: query.isItalic ? _notoSerifItalic : _notoSerif,
    PdfFontCharset.easternEuropean: query.isItalic ? _notoSerifItalic : _notoSerif,
    PdfFontCharset.ansi: null,
    PdfFontCharset.default_: null,
    PdfFontCharset.symbol: null,
  };
  final Map<PdfFontCharset, Map<int, GoogleFontsFileSingle>?> isRomanFalse = {
    ...
    PdfFontCharset.greek: query.isItalic ? _notoSansItalic : _notoSans,
    PdfFontCharset.vietnamese: query.isItalic ? _notoSansItalic : _notoSans,
    PdfFontCharset.cyrillic: query.isItalic ? _notoSansItalic : _notoSans,
    PdfFontCharset.easternEuropean: query.isItalic ? _notoSansItalic : _notoSans,
    PdfFontCharset.ansi: null,
    PdfFontCharset.default_: null,
    PdfFontCharset.symbol: null,
  };
  final fontTable = query.isRoman ? isRomanTrue[query.charset] : isRomanFalse[query.charset];
