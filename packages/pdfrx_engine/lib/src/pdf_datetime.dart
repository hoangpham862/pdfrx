...
class PdfDateTime {
  ...
  static PdfDateTime? fromPdfDateString(String? pdfDateString) => pdfDateString != null ? PdfDateTime(pdfDateString) : null;
  ...
  /// [DateTime] is in UTC.
  DateTime toDateTime() => DateTime.utc(year, month, day, hour, minute, second).subtract(Duration(minutes: timezoneOffset));
  ...
  PdfDateTime canonicalize() => PdfDateTime.fromYMDHMS(year, month, day, hour, minute, second, timeZoneOffset: timezoneOffset);

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is PdfDateTime && runtimeType == other.runtimeType && pdfDateString == other.pdfDateString;
